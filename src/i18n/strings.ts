...
export const RU_STRINGS: Record<string, string> = {
  ...
  'product.unavailable': 'Товары в данный момент недоступны',
  ...
  // --- footer ---
  'footer.terms':
    'Доставка: самовывоз из магазина в Кривом Роге или Новая Почта по всей Украине по тарифам перевозчика. Возврат: 14 дней на товар надлежащего качества — неиспользованный, с целой упаковкой и комплектацией — согласно Закону Украины «О защите прав потребителей».',
